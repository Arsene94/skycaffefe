...
export const metadata: Metadata = generatePageMetadata({
  ...
  description: 'Sky Caffe - bistro premium pe rooftop în centrul Năvodariului. Livrare rapidă pizza, paste, burgeri și deserturi. Program L-D 10:00-22:30. Comandă online!',
  keywords: [
