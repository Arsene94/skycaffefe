        ...
        <main role="main">
          ...
          <section className="relative z-10 h-[60vh] md:h-[70vh] lg:h-[80vh] flex items-center justify-center text-white">
            ...
            <div className="relative z-10 text-center text-white px-4 max-w-4xl">
              <Badge className="bg-white/20 text-white border-white/30 mb-4">Rooftop Experience</Badge>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
                <Button asChild size="lg" className="text-lg px-8 py-4 bg-white text-[hsl(var(--primary))] hover:bg-white/90">
                  <Link href="/meniu" prefetch={false}>Explorează meniul</Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="text-lg px-8 py-4 bg-white/10 border-white/30 text-white hover:bg-white/20">
                  <Link href="/despre" prefetch={false}>Despre noi</Link>
                </Button>
              </div>
            </div>
