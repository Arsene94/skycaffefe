...
const categoryIcons = { grid: Grid3X3 /* + restul dacă le folosești */ } as const
    ...
    useEffect(() => {
        ;(async () => {
            try {
                ...
                if (!Array.isArray(categories) || categories.length === 0) return setRecommendedProducts([])
                    ...
                    <ul className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6" aria-label="Categorii populare">
                        {loadingCats ? (
                            ...
                            popularCategories.map((category) => {
                                const Icon = (categoryIcons as any)[category.icon ?? 'grid'] || Grid3X3
                                return (
                                    <li key={category.id}>
                            ...
                            <li className="col-span-full text-center text-muted-foreground">Momentan nu există categorii populare.</li>
                        )}
                    </ul>
                </div>
            </section>
            ...
            >
                <div className="container mx-auto px-4">
                    ...
                    {(recommendedProducts.length > 0 || loadingRecs) ? (
                        ...
                        <p className="text-center col-span-full text-muted-foreground">Momentan nu există preparate recomandate.</p>
                    )}
